...
interface UploadFileDrawerProps {
  ...
  loadingDownloadAllFiles?: boolean;
}

const fileType =
  '.png,.PNG,.jpg,.JPG,.JPEG,.jpeg,.xls,.xlsx,.XLS,.XLSX,.doc,.DOC,.docx,.DOCX,.pdf,.PDF,.rar,.RAR,.zip,.ZIP,.msg,.MSG';
    ...
    >
      <div>
        ...
        >
          ...
          <p className='ant-upload-hint'>{I18N.eca.supportPdf2}</p>
        </Upload.Dragger>
        ...
        {/* 已上传列表展示区域 */}
        <div className={style.uploadTipWrapper}>
          <div className={style.uploadTip}>
          ...
          <Button
            type='link'
            loading={loadingDownloadAllFiles}
