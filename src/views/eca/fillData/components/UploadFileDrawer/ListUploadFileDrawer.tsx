...
const ListUploadFileDrawer: React.FC<UploadFileDrawerProps> = ({
  filesList,
  sizeLimit = 50,
  visible,
  onClose,
  ...
  const handleChange = (info: UploadChangeParam<UploadFile>) => {
    if (allUploadedFiles?.length === maxCount) {
      Toast('error', '最多支持上传5个附件');
      return;
    }
      ...
      <div>
        ...
        >
          ...
          <p className='ant-upload-hint'>
            每行数据最多支持上传5个附件，格式支持pdf、doc、docx、xls、xlsx、png、jpg、jpeg、zip、rar，每个文件不超过50M。
          </p>
        </Upload.Dragger>
...
export default ListUploadFileDrawer;
