 ...
 */
export const getGeneralInfoDetail = (params: { authNo: string }) =>
  request<ResponseData<GeneralInfoProps>>({
    method: 'GET',
    url: `/cbam/cbam/getAuthComputationInfo`,
    params,
  });
...
export const getSourceFlowDetail = (params: { id: number }) =>
  request<ResponseData<SourceFlowResp>>({
    method: 'GET',
    url: `/cbam/sourceFlow/auth/info/${params.id}`,
    params,
  });
...
export const getProductProcessListApi = (params: ProductProcessRequest) =>
  request<ResponseData<ProductProcessResp[]>>({
    method: 'GET',
    url: '/cbam/productProcess/auth/findPage',
    params,
  });
...
export const getProductProcessDetail = (params: { id: number }) =>
  request<ResponseData<ProductProcessResp>>({
    method: 'GET',
    url: `/cbam/productProcess/auth/${params.id}`,
    params,
  });
...
export const getOutsourcedPrecursorListApi = (
  ...
  request<ResponseData<OutsourcedPrecursorResp[]>>({
    method: 'GET',
    url: '/cbam/productPrecursor/auth/findPage',
    params,
  });
...
export const getOutsourcedPrecursorDetail = (params: { id: number }) =>
  request<ResponseData<OutsourcedPrecursorResp>>({
    method: 'GET',
    url: `/cbam/productPrecursor/auth/${params.id}`,
    params,
  });
...
export const getProcessEmissionListApi = (params: ProcessEmissionRequest) =>
  request<ResponseData<ProcessEmissionResp[]>>({
    method: 'GET',
    url: '/cbam/sourceFlow/auth/findPage',
    params,
  });
 ...
 */
export const getProductDataProcessDetail = (params: {
  id: number;
  authNo?: string;
}) =>
  request<ResponseData<ProductProcessResp>>({
    method: 'GET',
    url: `/cbam/productProcess/auth/processDataInfo`,
    params,
  });
 ...
 */
export const getProductOutsourcedPrecursorDetail = (params: {
  id: number;
  authNo: string;
}) =>
  request<ResponseData<OutsourcedPrecursorResp>>({
    method: 'GET',
    url: `/cbam/productPrecursor/auth/processDataInfo`,
    params,
  });
 ...
 */
export const getHeatPowerDetail = (params: { authNo: string }) =>
  request<ResponseData<HeatPowerResp>>({
    method: 'GET',
    url: `/cbam/productProcess/getAuthHotEleInfo`,
    params,
  });
...
export const getSaleProductListApi = (params: SaleProductRequest) =>
  request<ResponseData<SaleProductResp[]>>({
    method: 'GET',
    url: '/cbam/saleProduct/auth/findPage',
    params,
  });
...
export const getSaleProductDetail = (params: { id: number }) =>
  request<ResponseData<SaleProductResp>>({
    method: 'GET',
    url: `/cbam/saleProduct/auth/${params.id}`,
    params,
  });
...
export const getCarbonTaxListApi = (params: CarbonTaxRequest) =>
  request<ResponseData<CarbonTaxResp[]>>({
    method: 'GET',
    url: '/cbam/saleTax/auth/findPage',
    params,
  });
 ...
 */
export const getDataQualityDetail = (params: { authNo: string }) =>
  request<ResponseData<DataQualityResp>>({
    method: 'GET',
    url: `/cbam/productResult/auth/${params.authNo}`,
    params,
  });
...
export const getResultsSummarySunburst = (
  ...
  request<ResponseData<SunDTO[]>>({
    method: 'GET',
    url: `/cbam/productResult/auth/getInnerAuthSun`,
    params,
  });
...
export const getResultsSummaryPreEmission = (
  ...
  request<ResponseData<SunDTO[]>>({
    method: 'GET',
    url: `/cbam/productResult/getAuthPreEmission`,
    params,
  });
 ...
 */
export const getResultsSummaryTop = (params: { authNo: string }) =>
  request<ResponseData<SaleTaxResultDTO[]>>({
    method: 'GET',
    url: `/cbam/productResult/getAuthTop10`,
    params,
  });
 ...
 */
export const getProcessResultEdge = (params: { authNo?: string }) =>
  request<ResponseData<EdgeResultDTO>>({
    method: 'GET',
    url: `/cbam/productResult/authResultEdge`,
    params,
  });
