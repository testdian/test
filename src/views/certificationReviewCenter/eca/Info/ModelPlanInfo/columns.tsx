...
import { FillAssessmentResp } from '@/views/supplyChainCarbonManagement/CarbonDataFill/Info/CarbonFootPrintFill/type';

const { show } = PageTypeInfo;

/** 方案列表 */
export const modelPlanColumns =
  (): TableRenderProps<FillAssessmentResp>['columns'] => [
    {
