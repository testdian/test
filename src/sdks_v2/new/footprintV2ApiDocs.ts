...
export type DELETEe05836d479c78ce80f70133b1a879d60Props = {
  id: number;
};

export const DELETEe05836d479c78ce80f70133b1a879d60 = (
  { id }: DELETEe05836d479c78ce80f70133b1a879d60Props,
  $config?: AxiosRequestConfig,
...
export const getFootprintFileDownload = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象PageFileDownload> => {
  let backendApiUrl = `/footprint/fileDownload`;

  return axios.request<通用接口返回对象PageFileDownload>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      createBy: createBy,
...
export type getFootprintFileDownloadUpdateFieldProps = {};

export const getFootprintFileDownloadUpdateField = (
  {}: getFootprintFileDownloadUpdateFieldProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<unknown> => {
  let backendApiUrl = `/footprint/fileDownload/updateField`;
...
export type PUT0b4c8b58fa23966d6cf0af7ab9ec1cb1Props = {
  fileDownload: FileDownload;
};

export const PUT0b4c8b58fa23966d6cf0af7ab9ec1cb1 = (
  { fileDownload }: PUT0b4c8b58fa23966d6cf0af7ab9ec1cb1Props,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
  let backendApiUrl = `/footprint/fileDownload`;
...
export const postFootprintFileUpload = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象FileUpload> => {
  let backendApiUrl = `/footprint/fileUpload`;

  return axios.request<通用接口返回对象FileUpload>({
    url: backendApiUrl,
    method: 'POST',
    data: fileUpload,
    // baseURL: `${process.env.REACT_APP_API_URL}`,
...
export type PUT19115626fa4e59d4ebd1ca7392fcc5feProps = {
  fileUpload: FileUpload;
};

export const PUT19115626fa4e59d4ebd1ca7392fcc5fe = (
  { fileUpload }: PUT19115626fa4e59d4ebd1ca7392fcc5feProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
  let backendApiUrl = `/footprint/fileUpload`;
...
export const getFootprintProductionCompanyList = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象List> => {
  let backendApiUrl = `/footprint/production/companyList`;

  return axios.request<通用接口返回对象List>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
...
export type DELETEf346fcf75edc07242a7879c1164cf3e1Props = {
  idList: number;
};

export const DELETEf346fcf75edc07242a7879c1164cf3e1 = (
  { idList }: DELETEf346fcf75edc07242a7879c1164cf3e1Props,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
...
export type deleteFootprintProductionBusinessProps = {
  id: number;
};

export const deleteFootprintProductionBusiness = (
  { id }: deleteFootprintProductionBusinessProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
...
export type DELETE8ac1cbfab448afe7c7ffbe18dd00139bProps = {
  id: number;
};

export const DELETE8ac1cbfab448afe7c7ffbe18dd00139b = (
  { id }: DELETE8ac1cbfab448afe7c7ffbe18dd00139bProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
...
export type DELETEd4be5b99566226235ef8ffffc63a4d63Props = {
  id: number;
};

export const DELETEd4be5b99566226235ef8ffffc63a4d63 = (
  { id }: DELETEd4be5b99566226235ef8ffffc63a4d63Props,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
...
export type DELETE9998887ead15eab011d1efdf8c10701aProps = {
  id: number;
};

export const DELETE9998887ead15eab011d1efdf8c10701a = (
  { id }: DELETE9998887ead15eab011d1efdf8c10701aProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
...
export const postFootprintProductionBusiness = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象ProductionBusiness> => {
  let backendApiUrl = `/footprint/productionBusiness`;

  return axios.request<通用接口返回对象ProductionBusiness>({
    url: backendApiUrl,
    method: 'POST',
...
export const postFootprintProduction = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象Production> => {
  let backendApiUrl = `/footprint/production`;

  return axios.request<通用接口返回对象Production>({
    url: backendApiUrl,
    method: 'POST',
    data: production,
    // baseURL: `${process.env.REACT_APP_API_URL}`,
...
export const postFootprintProductionMaterials = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象ProductionMaterials> => {
  let backendApiUrl = `/footprint/productionMaterials`;

  return axios.request<通用接口返回对象ProductionMaterials>({
    url: backendApiUrl,
    method: 'POST',
...
export const getFootprintProcessModel = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象PageProcessModel> => {
  let backendApiUrl = `/footprint/processModel`;

  return axios.request<通用接口返回对象PageProcessModel>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      delFlag: delFlag,
...
export const getFootprintProductionBusiness = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象PageProductionBusiness> => {
  let backendApiUrl = `/footprint/productionBusiness`;

  return axios.request<通用接口返回对象PageProductionBusiness>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      beginDate: beginDate,
...
export const getFootprintProduction = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象PageProduction> => {
  let backendApiUrl = `/footprint/production`;

  return axios.request<通用接口返回对象PageProduction>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      basicUnit: basicUnit,
...
export const getFootprintProductionMaterials = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象PageProductionMaterials> => {
  let backendApiUrl = `/footprint/productionMaterials`;

  return axios.request<通用接口返回对象PageProductionMaterials>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
...
export const getFootprintReport = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象PageReport> => {
  let backendApiUrl = `/footprint/report`;

  return axios.request<通用接口返回对象PageReport>({
    url: backendApiUrl,
    method: 'GET',
    params: serializeQueryParam({
      beginDate: beginDate,
...
export const getFootprintProcessModelId = (
  ...
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象ProcessModel> => {
  let backendApiUrl = `/footprint/processModel/${id}`;
  backendApiUrl = backendApiUrl.replace('{id}', encodeURIComponent('' + id));

  return axios.request<通用接口返回对象ProcessModel>({
    url: backendApiUrl,
    method: 'GET',
    // baseURL: `${process.env.REACT_APP_API_URL}`,
    ...$config,
...
export type PUT2d6960baa73584a79b5016f1bd955e35Props = {
  processModel: ProcessModel;
};

export const PUT2d6960baa73584a79b5016f1bd955e35 = (
  { processModel }: PUT2d6960baa73584a79b5016f1bd955e35Props,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
  let backendApiUrl = `/footprint/processModel`;
...
export type PUT1d9a3ae2adea64e3e84bf06ae2abcd4dProps = {
  productionBusiness: ProductionBusiness;
};

export const PUT1d9a3ae2adea64e3e84bf06ae2abcd4d = (
  { productionBusiness }: PUT1d9a3ae2adea64e3e84bf06ae2abcd4dProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
  let backendApiUrl = `/footprint/productionBusiness`;
...
export type PUTd8062f9627e8c931a7a904f835189481Props = {
  production: Production;
};

export const PUTd8062f9627e8c931a7a904f835189481 = (
  { production }: PUTd8062f9627e8c931a7a904f835189481Props,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
  let backendApiUrl = `/footprint/production`;
...
export type PUT280808b2d6d31bb8574eb9d6cf4387b5Props = {
  productionMaterials: ProductionMaterials;
};

export const PUT280808b2d6d31bb8574eb9d6cf4387b5 = (
  { productionMaterials }: PUT280808b2d6d31bb8574eb9d6cf4387b5Props,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
  let backendApiUrl = `/footprint/productionMaterials`;
...
export type PUTe471e1b506b7616f3d403044f6241ebcProps = {
  report: Report;
};

export const PUTe471e1b506b7616f3d403044f6241ebc = (
  { report }: PUTe471e1b506b7616f3d403044f6241ebcProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象boolean> => {
  let backendApiUrl = `/footprint/report`;
...
export type getFootprintSupplierDataChooseApplyInfoIdProps = {
  applyInfoId: number;
};

export const getFootprintSupplierDataChooseApplyInfoId = (
  { applyInfoId }: getFootprintSupplierDataChooseApplyInfoIdProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象SupplierGasResp> => {
  let backendApiUrl = `/footprint/supplierData/choose/${applyInfoId}`;
...
export type getFootprintSupplierDataFootprintApplyInfoIdProps = {
  applyInfoId: number;
};

export const getFootprintSupplierDataFootprintApplyInfoId = (
  { applyInfoId }: getFootprintSupplierDataFootprintApplyInfoIdProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象FootprintResult> => {
  let backendApiUrl = `/footprint/supplierData/footprint/${applyInfoId}`;
...
export type getFootprintSupplierDataPageProps = {
...
export const getFootprintSupplierDataPage = (
  {
    likeProductName,
    likeSupplierName,
    pageNum,
    pageSize,
  }: getFootprintSupplierDataPageProps,
  $config?: AxiosRequestConfig,
): AxiosPromise<通用接口返回对象IPageProductDto> => {
  let backendApiUrl = `/footprint/supplierData/page`;
...
export interface 通用接口返回对象FileDownload {
  code: number;
...
export interface 通用接口返回对象FileUpload {
  code: number;
...
export interface 通用接口返回对象PageFileDownload {
  code: number;
...
export interface 通用接口返回对象PageProcessModel {
  code: number;
...
export interface 通用接口返回对象PageProductionBusiness {
  code: number;
...
export interface 通用接口返回对象PageProductionMaterials {
  code: number;
...
export interface 通用接口返回对象PageProduction {
  code: number;
...
export interface 通用接口返回对象PageReport {
  code: number;
...
export interface 通用接口返回对象ProcessModel {
  code: number;
...
export interface 通用接口返回对象ProductionBusiness {
  code: number;
...
export interface 通用接口返回对象ProductionMaterials {
  code: number;
...
export interface 通用接口返回对象Production {
  code: number;
